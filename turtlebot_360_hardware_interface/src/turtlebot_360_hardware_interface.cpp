...
******************************************************************************/
#include "turtlebot_360_hardware_interface.h"
...
void setparamsCallback(turtlebot_360_hardware_interface::turtlebot_360_hardware_interface_paramsConfig &config, uint32_t level)
{
    // set params
    params = config;
...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "turtlebot_360_hardware_interface");

    ros::NodeHandle node;


    //setup dynamic reconfigure gui
    dynamic_reconfigure::Server<turtlebot_360_hardware_interface::turtlebot_360_hardware_interface_paramsConfig> srv;
    dynamic_reconfigure::Server<turtlebot_360_hardware_interface::turtlebot_360_hardware_interface_paramsConfig>::CallbackType f;
    ...
    {
        ROS_WARN("turtlebot_360_hardware_interface: twist has not been remapped! Typical command-line usage:\n"
                 "\t$ ./turtlebot_360_hardware_interface twist:=<image topic> [transport]");
    }
    ...
    sensor_pub = node.advertise<turtlebot_360_hardware_interface::BaseData>("turtlebot_360_hardware_interface/sensor_data", 5);
...
void publishSensorData()
{
    ...
    turtlebot_360_hardware_interface::BaseData msg;
