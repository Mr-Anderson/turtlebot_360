...
void serial_port::serial_open(const char * name)
{
	serial_open(name, baud_rate);
}

//open
//	Opens the serial port <name> at baud rate <baud>
void serial_port::serial_open(const char* name, unsigned int baud)
{
